                                  ...
                                  tabPanel("Recommendations", 
                                        ...
                                        #2.column  
                                           column(width = 6,
                                              ...
                                              tags$head(tags$style("#urloutR tr:first-child td {border-color: transparent; 
                                                                  font-size: 13px; font-weight: bold; background-color: #7AA95C; color: white; }", 
                                                                   media="screen", type="text/css")),
                                              tags$head(tags$style("#urloutR table {border-color: transparant; 
                        ...
                        #Learn more page             ############################################################## 
                                  tabPanel("Learn more",
                                          ...
                                          column(width = 6,
                                                 ...
                                                 h4("...the ingredients with the most emissions are",  
                                                    align="center"),
